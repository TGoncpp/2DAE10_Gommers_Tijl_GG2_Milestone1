...
void Texture::createTextureImage(VkImage& image, VkDeviceMemory& imageMemory, const std::string& path)
{
...
void Texture::createDescriptorPool(VkDescriptorPool& descriptorpool)
{
}

void Texture::createDescriptorSets(VkDescriptorPool& descriptorpool, std::vector<VkDescriptorSet>& vDescriptorSets, VkImageView imageView)
{
}
